...
//    static {
//        String user = UserSettings.getProperty("auth.username");
//        String pass = UserSettings.getProperty("auth.password");
//        
//        mongoDBConnection = new MongoDBConnection(user, pass);
//    }
    ...
    /**
     * Starts a threaded execution parsing a PDF into Item objects. On
     * completion, runs a {@link Runnable} callback.
     *
     * @param file The file to parse
     * @param planogramName The name of the planogram to associate with the
     * items
     * @param callback The callback execution to run on finish
     */
    ...
    private static Planogram createNewPlanogram(String name, ArrayList<Item> items) {
        ...
        planogramHandler.addPlanogram(p);
        return p;
    }
